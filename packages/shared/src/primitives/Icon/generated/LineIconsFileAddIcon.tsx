...
export interface LineIconsFileAddIconProps {
  /**
   * 아이콘 크기
   */
  size?: number | string;
...
/**
 * LineIconsFileAddIcon 아이콘 컴포넌트
 * 
 * @param props - 아이콘 속성
 * @returns JSX 엘리먼트
 */
export const LineIconsFileAddIcon: React.FC<LineIconsFileAddIconProps> = ({
  size = 24,
  color = 'currentColor',
  className,
  style,

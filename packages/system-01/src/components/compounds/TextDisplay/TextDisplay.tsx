...
import { Frame, Surface, Text, Icon, IconName } from 'lumir-design-system-shared';
...
export const TextDisplay = forwardRef<HTMLDivElement, TextDisplayProps>(({
  ...
  const getForegroundColors = () => {
    return {
          label: 'secondary-system01-2-rest' as const,
    primary: 'secondary-system01-1-rest' as const,
    description: 'secondary-system01-2-rest' as const,
    caption: 'secondary-system01-3-rest' as const,
    };
  };
